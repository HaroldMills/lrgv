...
file list for the Lighthouse project.

Usage:
    python create_recording_metadata_files_lighthouse.py
...
an inputfile is:
    ...
    "/Volumes/Recordings/Barker_2025-04-09_01.22.52_Z.wav","Barker_2025-04-09_01.22.52_Z.wav",1,22050,783127800,9:51:56.000
...
Recordings
    ...
    Vesper Recorder
        Recording Files.csv
        Incoming
            Barker_2025-07-30_07.03.18.800_Z.json
